...
class CustomThemeDescriptionViewHolder(
    itemView: View,
    ...
    override val popupMenuListener = object : PopupMenuHelper.Listener {
        override fun onItemClicked(menuItemId: Int) {
            val themeId = themeDescription?.id ?: return
            when (menuItemId) {
                EDIT_ID -> onEditTheme(themeId)
                DELETE_ID -> onDeleteTheme(themeId)
            }
        }
    }
    ...
    private var themeDescription: CustomTheme.Description? = null
    ...
    override fun generateMenuItems(): List<PopupWindowMenuItem> {
        ...
        menuItems.add(
            PopupWindowMenuItem(
                ...
                PopupWindowMenuItem.Title(contentRes = R.string.custom_theme_menu_item_edit),
            )
        )
        ...
        menuItems.add(
            PopupWindowMenuItem(
                ...
                PopupWindowMenuItem.Title(contentRes = R.string.custom_theme_menu_item_delete),
